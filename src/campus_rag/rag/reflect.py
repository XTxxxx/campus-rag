...
async def reflect_query(query: str, context: List[str]) -> dict:
  """
  ...
  prompt_content = {
    ...
    "content": f"""
        ...
        Determine if:
        1. The question is irrelevant to the Campus information about Nanjing University (category 1)
        2. The question is relevant but the context doesn't provide enough information to answer it (category 2)
        3. The question can be properly answered with the given context (category 3)
...
if __name__ == "__main__":
  ...
  result = reflect_query(query, context)
