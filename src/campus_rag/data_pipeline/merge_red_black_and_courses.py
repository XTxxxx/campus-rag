...
def check(src_teacher_name: str, target_teacher_name: str):
    if not src_teacher_name or not target_teacher_name:
        return False
    return src_teacher_name == target_teacher_name or src_teacher_name in target_teacher_name
...
# 写回
json.dump(courses, open("../../../data/course_list_rb.json", "w", encoding="utf-8"), ensure_ascii=False, indent=2)
